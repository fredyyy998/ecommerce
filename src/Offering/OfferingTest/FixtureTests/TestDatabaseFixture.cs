...
public class TestDatabaseFixture
{
    ...
    public void CreateMockOffers(DataContext context)
    {
        ...
        var offer2 = SingleOffer.Create(Guid.Parse("7d67521c-6a66-428d-918d-d77a7780892d"),"Offer 2", price2, DateTime.Now, DateTime.Now.AddDays(1),  GetProductById(Guid.Parse("07d6faf7-ad39-4810-82f7-1f4b40e3c877"), context), localisation);
        var price3 = Price.CreateFromGross(10, 19);
        var offer3 = SingleOffer.Create(Guid.Parse("c216d6f5-c2cf-4ada-b816-13a23c0cce70"), "Offer 3", price3, DateTime.Now, DateTime.Now.AddDays(1), GetProductById(Guid.Parse("c2511115-cb17-4deb-8c00-d5b1b787327a"), context), localisation);
        var price4 = Price.CreateFromGross(10, 19);
        var offer4 = SingleOffer.Create(Guid.Parse("e36f7dc3-ea03-41e8-bbb1-508e970f43bd"), "Offer 4", price4, DateTime.Now, DateTime.Now.AddDays(1), GetProductById(Guid.Parse("07d6faf7-ad39-4810-82f7-1f4b40e3c877"), context), localisation);
        
        var price5 = Price.CreateFromGross(10, 19);
        var offer5 = PackageOffer.Create(Guid.Parse("ac0b52d3-54cd-4572-b32d-6f65aed7e610"),"Package Offer 1", price5, DateTime.Now, DateTime.Now.AddDays(1), new List<Product> { GetProductById(Guid.Parse("07d6faf7-ad39-4810-82f7-1f4b40e3c877"), context), GetProductById(Guid.Parse("43ff93b2-3272-4dbf-bcd3-263212e7a7f6"), context) }, localisation);
        var price6 = Price.CreateFromGross(10, 19);
        var offer6 = PackageOffer.Create(Guid.Parse("d40c43d3-7285-4fab-aea4-9343e99e6bb6"),"Package Offer 2", price6, DateTime.Now, DateTime.Now.AddDays(1), new List<Product> { GetProductById(Guid.Parse("c2511115-cb17-4deb-8c00-d5b1b787327a"), context), GetProductById(Guid.Parse("43ff93b2-3272-4dbf-bcd3-263212e7a7f6"), context) }, localisation);
        
        context.Offers.AddRange(offer, offer2, offer3,offer4, offer5, offer6);
        context.SaveChanges();
    }
    
    private Product GetProductById(Guid id, DataContext context)
    {
